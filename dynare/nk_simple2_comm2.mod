// Gali Ch.3 examples. We set alpha = 1.
// December 2015, Takeki Sunakawa
// updated January 2016

parameters beta sigma kappa phip phiy rho rhou vtheta;
var x pai u;
varexo epsu;
...
//ramsey_policy(nograph, irf=16) x pai u;
